...
type
  ...
  TInitActionColorProc = procedure (BtnID: Integer; Action: Integer; cla: TRggColor) of object;
  ...
  protected
    ...
    procedure IAC(BtnID, Action: Integer; cla: TRggColor); virtual;
  public
    constructor Create;
  ...
  private
    ...
    procedure TestProcOneIAC(BtnID, Action: Integer; cla: TRggColor);
    procedure TestProcAllIAC(BtnID, Action: Integer; cla: TRggColor);
  protected
    TestAction: Integer;
    TestPage: Integer;
    TestList: TStrings;
...
procedure TActionMapBase.IAC(BtnID, Action: Integer; cla: TRggColor);
begin
...
procedure TCollectibleActionMap.TestProcOneIAC(BtnID, Action: Integer; cla: TRggColor);
begin
...
procedure TCollectibleActionMap.TestProcAllIAC(BtnID, Action: Integer; cla: TRggColor);
begin
