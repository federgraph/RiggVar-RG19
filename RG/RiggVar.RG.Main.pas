...
begin
  try
    ...
    RiggModul.ViewModelM.Caption := 'Rigg - ' + ExtractFileName(IniFileName);
    RiggModul.UpdateUI;
    RiggModul.UpdateGControls;
...
procedure TRggMain.ViewpointS;
begin
  RiggModul.ViewPoint := TViewpoint.vpSeite;
end;

procedure TRggMain.ViewpointA;
begin
  RiggModul.ViewPoint := TViewpoint.vpAchtern;
end;

procedure TRggMain.ViewpointT;
begin
  RiggModul.ViewPoint := TViewpoint.vpTop;
end;

procedure TRggMain.Viewpoint3;
begin
