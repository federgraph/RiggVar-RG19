...
begin
  FAP := Value;
  XLEDFillColor := clYellow;
  PLEDFillColor := clYellow;
  UpdateXMinMax;
  UpdatePMinMax;
end;
...
begin
  ...
  if FDarkColors then
  begin
    cf[0] := TRggColors.Blue;
    cf[1] := TRggColors.Red;
    cf[2] := TRggColors.Green;
    cf[3] := TRggColors.White;
    cf[4] := TRggColors.Yellow;
  end
  else
  begin
    cf[0] := TRggColors.Aqua;
    cf[1] := TRggColors.Fuchsia;
    cf[2] := TRggColors.Lime;
    cf[3] := TRggColors.White;
    cf[4] := TRggColors.Yellow;
  end;
end;
